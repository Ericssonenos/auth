...
IF OBJECT_ID('RH.Tbl_Usuario', 'U') IS NULL
BEGIN
    CREATE TABLE RH.Tbl_Usuario
    (
        id_Usuario CHAR(7) NOT NULL UNIQUE,
...
BEGIN
    ...
    (
        ...
        criado_Usuario_id CHAR(7) NOT NULL,
...
BEGIN
    ...
    (
        ...
        CONSTRAINT FK_Rel_Usuario_Grupos_Usuario FOREIGN KEY (Usuario_id) REFERENCES RH.tbl_Usuario(id_Usuario)
    );
...
BEGIN
    ...
    (
        ...
        CONSTRAINT FK_Rel_Usuario_Permissao_Usuario FOREIGN KEY (Usuario_id) REFERENCES RH.tbl_Usuario(id_Usuario)
    );
