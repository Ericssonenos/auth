<?php $__env->startSection('title', 'Supplytek — Soluções em Solda'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section id="catalogo" class="container" style="padding: 12px 0 28px;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:14px;">
            <a class="btn btn-secondary" href="<?php echo e(route('em-desenvolvimento')); ?>" aria-label="Ver modelos MIG/MAG"><i class="bi bi-lightning-charge me-1" aria-hidden="true"></i>MIG/MAG</a>
            <a class="btn btn-secondary" href="<?php echo e(route('em-desenvolvimento')); ?>" aria-label="Ver modelos TIG"><i class="bi bi-droplet me-1" aria-hidden="true"></i>TIG</a>
            <a class="btn btn-secondary" href="<?php echo e(route('em-desenvolvimento')); ?>" aria-label="Ver modelos Eletrodo"><i class="bi bi-hammer me-1" aria-hidden="true"></i>MMA</a>
            <a class="btn btn-secondary" href="<?php echo e(route('em-desenvolvimento')); ?>" aria-label="Ver modelos Plasma"><i class="bi bi-scissors me-1" aria-hidden="true"></i>Plasma</a>
            <a class="btn btn-secondary" href="<?php echo e(route('em-desenvolvimento')); ?>" aria-label="Ver acessórios e consumíveis"><i class="bi bi-box-seam me-1" aria-hidden="true"></i>Acessórios</a>
        </div>
    </section>
    ...
    <section id="orcamento" class="container" style="padding: 12px 0 36px;">
        <div class="card">
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap">
                ...
                <a href="<?php echo e(route('em-desenvolvimento')); ?>" class="btn btn-ghost" aria-label="Baixar catálogo em PDF">Baixar catálogo PDF</a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Repositorio\Mind\auth\resources\views/welcome.blade.php ENDPATH**/ ?>