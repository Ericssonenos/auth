...
<body>
    ...
    {{-- Exemplo: mostrar bloco somente se usuário tiver PERM_VISUALIZAR_RELATORIOS --}}
    @can('PERM_VISUALIZAR_RELATORIOS')
        <div style="padding:1rem;border:1px solid #2a9d8f;background:#e9f7f2">
            <h2>Área restrita</h2>
            <p>Você tem permissão para visualizar relatórios.</p>
